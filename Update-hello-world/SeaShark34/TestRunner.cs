...
namespace SimpleCSharpSelenium
{
    public static class TestRunner
    {
        ...
        // Xpanxion page set up
        private static Pages.XpanxionAboutPage xpanxionAbout = null;
        private static Pages.XpanxionHomePage xpanxionHome = null;
        
        public static Pages.XpanxionAboutPage XpanxionAboutPage
        {
            get
            {
                if (xpanxionAbout == null)
                {
                    xpanxionAbout = new Pages.XpanxionAboutPage();
                }
                return xpanxionAbout;
            }
        }

        public static Pages.XpanxionHomePage XpanxionHomePage
        {
            get
            {
                if (xpanxionHome == null)
                {
                    xpanxionHome = new Pages.XpanxionHomePage();
                }
                return xpanxionHome;
            }
        }
